...
public class eCommerce_tc_3 extends BaseTest {
    ...
    public void switchToWeb() throws InterruptedException {
        ...
        //Получаем доступ к режимам приложения и записываем в контекст
        Set<String> contexts = driver.getContextHandles();
        //Перебираем все данные в контесте и выводим их в консоль
        ...
        //Перекелючаемся на webview
        driver.context("WEBVIEW_com.androidsample.generalstore");
        driver.get("https://habr.com/ru/articles/");
        //Вписываем текст в строку поиска гугл и клац ентер
        //driver.findElement(By.name("q")).sendKeys("Hello world");
        //driver.findElement(By.name("q")).sendKeys(Keys.ENTER);
        //Переключаемся назад на native режим
        driver.context("NATIVE_APP");
        //Клацаем кнопку назад
